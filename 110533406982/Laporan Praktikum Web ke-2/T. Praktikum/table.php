...
?>
  ...
  <strong>Kamu Memilih</strong> <?php echo $rows; ?> <em>rows,</em>
  <strong>dan</strong> <?php echo $columns; ?> <em>columns,</em><br />
  <strong>Dan Kamu Membutuhkan</strong> <?php echo $cells; ?> <em>cells,</em><br />
  <br />
  <br />
  <?php
    $width = $columns * 75;
